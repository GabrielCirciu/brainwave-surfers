...
def main():
    ...
    parser.add_argument("--save_plot", default="scores_environemnts.pdf", help="Path to save the generated plot.")
    ...
    if args.metric != "accuracy" and save_path == "scores_environemnts.pdf":
        save_path = f"scores_environemnts_{args.metric.upper()}.pdf"
